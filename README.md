...
27. `top_media_type.sql`: Provide a query that shows the most purchased Media Type. - [Complete](https://github.com/broach44/chinook/blob/master/top_media_type.sql)